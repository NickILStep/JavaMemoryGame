...
class MemCards {
   ...
   public void addScore(String name, int score) {
      try {
         PrintWriter fileOut = new PrintWriter(new FileWriter("scorelog.txt", true));
   ...
   public String scoresToString() {
      String scoreList = "";
      try {
         File scoreFile = new File("scorelog.txt");
         if(scoreFile.exists()) {
   ...
   public void playSound(URL audioFile, boolean playYN) {
      if(playYN) {
         try {
