...
class MemGUI extends JPanel {
   ...
   private final JLabel creator = new JLabel("\u00A9 2020 Nick Stephenson");
...
//    String test = MemCards.scoresToString();
   ...
   public MemGUI() {
      ...
      creator.setBounds(300, 615, 150, 20);
   ...
   public void cardPositions() {
      ...
      //Play opening sound
      MemCards.playSound(this.getClass().getResource("Assets/Sounds/shuffle.wav"), soundYN);
   ...
   public void choiceMade() {
      //Play flip sound
      MemCards.playSound(this.getClass().getResource("Assets/Sounds/cardflip1.wav"), soundYN);
   ...
   public void resetBacks() {
      //Play flip sound
      MemCards.playSound(this.getClass().getResource("Assets/Sounds/cardflip2.wav"), soundYN);
   ...
   public void win() {
      //Play win sound
      MemCards.playSound(this.getClass().getResource("Assets/Sounds/win.wav"), soundYN);
